...
export default function DeleteBookingContent({
  bookingId,
  onCloseModal
}: {
  bookingId: string;
    ...
    <div className="p-4 md:p-5 text-center">
      ...
      <div className="flex items-center justify-center">
        <button
          onClick={handler}
          disabled={isPending}
          className="relative min-w-[108px] h-[42px] text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm flex items-center justify-center"
        >
